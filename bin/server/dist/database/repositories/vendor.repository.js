...
var vendorRepository = {
    findByName: function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var repo, data, error_1;
            var name = _b.name, runner = _b.runner;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        repo = runner.manager.getRepository(Vendor_1.Vendor);
                        return [4, repo.findOne({ where: { name: name } })];
                    case 1:
                        data = _c.sent();
                        return [2, data];
                    case 2:
    ...
    upsert: function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            ...
            var address = _b.address, name = _b.name, contact = _b.contact, runner = _b.runner, id = _b.id;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
