...
var billRepository = {
        ...
        return __awaiter(this, arguments, void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        repo = runner.manager.getRepository(Bill_1.Bill);
                        return [4, repo.find({
                                where: { vendor: { id: id } },
                                order: { date: "desc" },
                            })];
    ...
    findByBillNumber: function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            ...
            var billNumber = _b.billNumber, runner = _b.runner;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
    ...
    upsert: function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            ...
            var runner = _b.runner, id = _b.id, date = _b.date, vendorId = _b.vendorId, amount = _b.amount, billNumber = _b.billNumber;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
...
exports.default = billRepository;
